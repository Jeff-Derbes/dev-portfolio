...
function Main(props) {
  return (
      ...
      >
        <div
            className="w-full relative mx-auto flex justify-center md:justify-start lg:ml-64 md:ml-32 items-center md:text-left pb-32 md:mt-64">
          <div>
            ...
            <Link href="/#contact" scroll={false}>
              <button
                  className="relative inline-flex items-center justify-center p-0.5 mt-4 md:mt-12 overflow-hidden text-xl font-medium rounded-lg bg-accent ">
              <span
                  className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-primary rounded-md hover:bg-accent hover:text-black">
                Let&apos;s Connect{" "}
                <span>
                  <svg
